...
// Simpler calculation: divide available width evenly by column count
const ITEM_WIDTH = (width - (LIST_PADDING * 2) - (ITEM_MARGIN * (COLUMN_COUNT - 1))) / COLUMN_COUNT;
    ...
    <ScreenWrapper>
      <View style={styles.container}>
        ...
        {ownedSkins.length === 0 ? (
            ...
            <View style={[styles.listContainer, { marginBottom: selectedIds.length > 0 ? 120 : 20 }]}>
                <FlatList
                    data={ownedSkins}
